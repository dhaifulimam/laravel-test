        ...
        <main class="form-registration">
            ...
            <form action="/register" method="post">
              ...
              <div class="form-floating">
                ...
                is-invalid
                @enderror"  id="name" placeholder="Your Name" name="name" required value="{{ old('name') }}">
              ...
              <div class="form-floating">
                ...
                is-invalid @enderror" id="email" placeholder="Youremail@email.com" required value="{{ old('email') }}">
              ...
              <div class="form-floating">
                ...
                is-invalid
                @enderror" id="password" placeholder="YourPassword" name="password" required>
